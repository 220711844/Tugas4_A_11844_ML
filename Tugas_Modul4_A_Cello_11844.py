...
st.set_page_config(
    page_title="11844 - Unsupervised Learning",
    page_icon="📊",
    layout="wide",
...
if uploaded_file is not None:
    ...
    st.markdown("<h1 style='text-align: center;'>Unsupervised Learning - Cello</h1>", unsafe_allow_html=True)
    st.dataframe(input_data)

model_directory = r'D:\Kuliah\semester 5\Pembelajaran Mesin dan Mendalam\Unsupervised Learning (Praktek)\Tugas4_A_11844'
model_path = {
